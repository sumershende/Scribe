...
var creative = {
  ...
  quoteWrapper:null,
  quote: null,
  photographerBlock: null,
  photographerTitle: null,
  photographer: null,
  ctaText: null,
  ctaBackground: null,
  cta: null,
  ...
  init: function() {
    ...
    creative.statementContent = dynamicContent.Direct_Response_Creative_2016_Feed[0].Statement;
    creative.statementSize = dynamicContent.Direct_Response_Creative_2016_Feed[0].Statement_Point_Size;
    creative.photographerTitleContent = dynamicContent.Direct_Response_Creative_2016_Feed[0].iStock_Photographer;
    creative.photographerContent = dynamicContent.Direct_Response_Creative_2016_Feed[0].Photographer;
    creative.ctaTextContent = dynamicContent.Direct_Response_Creative_2016_Feed[0].Final_Text;
    creative.ctaTextSize = dynamicContent.Direct_Response_Creative_2016_Feed[0].Final_Text_Point_Size;
  ...
  setupDom: function() {
    ...
    creative.card=document.getElementById('card');
    creative.front=document.getElementById('front');
    creative.back=document.getElementById('back');

    creative.searchBox=document.getElementById('searchBox');
    creative.quoteWrapper=document.getElementById('quote-wrapper');
    creative.quote=document.getElementById('quote');
    creative.photographerBlock=document.getElementById('photographer-block');
    creative.photographerTitle=document.getElementById('photographer-title');
    creative.photographer=document.getElementById('photographer');
    creative.ctaText=document.getElementById('cta-text');
  ...
  setup: function() {
    //console.log('setup');
    creative.front.style.backgroundImage='url("'+creative.backgroundContent+'")';
    ...
    creative.quote.innerHTML=creative.statementContent;
    creative.quote.style.fontSize=creative.statementSize+'px';
    creative.quoteWrapper.style.bottom=(creative.photographerContent!='')?'40px':'0px';
    creative.photographerBlock.style.display=(creative.photographerContent!='')?'block':'none';
    creative.photographerTitle.innerHTML=creative.photographerTitleContent;
    creative.photographer.innerHTML=creative.photographerContent;
    creative.ctaText.innerHTML=creative.ctaTextContent;
    creative.ctaText.style.fontSize=creative.ctaTextSize+'px';
